...
app.layout = html.Div([
    ...
    html.H1(app.title,style={'textAlign': 'center', 'color': '#503D36', 'font-size': '24px'}),#Include style for title
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle_Type',
            y='Automobile_Sales',
            title="Average Vehicles Sales by Vehicle Type during Recession"))
